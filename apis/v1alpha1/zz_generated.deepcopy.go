...
func (in *AnalyticsExportDestination) DeepCopy() *AnalyticsExportDestination {
	...
	out := new(AnalyticsExportDestination)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BucketSpec) DeepCopyInto(out *BucketSpec) {
	*out = *in
	...
	if in.Analytics != nil {
		...
		*out = make([]*AnalyticsConfiguration, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AnalyticsConfiguration)
	...
	if in.IntelligentTiering != nil {
		in, out := &in.IntelligentTiering, &out.IntelligentTiering
		*out = make([]*IntelligentTieringConfiguration, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(IntelligentTieringConfiguration)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.Inventory != nil {
		...
		*out = make([]*InventoryConfiguration, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *IntelligentTieringConfiguration) DeepCopyInto(out *IntelligentTieringConfiguration) {
	*out = *in
	...
	if in.Tierings != nil {
		in, out := &in.Tierings, &out.Tierings
		*out = make([]*Tiering, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(Tiering)
...
func (in *NotificationConfiguration) DeepCopyInto(out *NotificationConfiguration) {
	*out = *in
	if in.EventBridgeConfiguration != nil {
		in, out := &in.EventBridgeConfiguration, &out.EventBridgeConfiguration
		*out = new(bool)
		**out = **in
	}
...
func (in *StorageClassAnalysis) DeepCopyInto(out *StorageClassAnalysis) {
	*out = *in
	if in.DataExport != nil {
		...
		*out = new(StorageClassAnalysisDataExport)
		(*in).DeepCopyInto(*out)
	}
}
